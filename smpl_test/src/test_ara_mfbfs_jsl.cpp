...
{
    ros::init(argc, argv, "test_ara_mfbfs_jsl");
    ros::NodeHandle ph("~");
    ...
    actions.SetIKMotionXYZRPYThreshold(0.20); // 0.2 in call_planner
    ...
    auto heuristic = smpl::MultiFrameBFSHeuristic();
    ...
    heuristic.SetOffset(0.18, 0.0, 0.0);
